...
$(document).ready(function(){
	$(".product_infor-color-item").click(function(){
		$(".product_infor-color-item").removeClass("active");
		$(this).addClass("active")
	})
	$(".product_infor-other-item").click(function(){
		$(".product_infor-other-item").removeClass("active");
		$(this).addClass("active")
	})
})
